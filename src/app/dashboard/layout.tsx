...
export default function DashboardLayout({
  ...
  return (
    <section className='container mx-auto px-4 flex'>
      <aside className='flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 z-10'>
